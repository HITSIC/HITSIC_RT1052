...
const uint8_t dcd_data[] = {
	...
	0xCC, 0x03, 0xAC, 0x04,
	/* #1.1, command: write_value, address: CCM_CCGR0, value: 0xFFFFFFFF, size: 4, comment: 'Clock configuratuion' */
	...
	/* #1.8, command: write_value, address: CCM_ANALOG_PLL_SYS, value: 0x80002001, size: 4 */
	0x40, 0x0D, 0x80, 0x30, 0x80, 0x00, 0x20, 0x01,
	/* #1.9, command: write_value, address: CCM_ANALOG_PFD_528, value: 0x101b1018, size: 4 */
	0x40, 0x0D, 0x81, 0x00, 0x10, 0x1B, 0x10, 0x18,
	/* #1.10, command: write_value, address: CCM_CBCDR, value: 0x28380, size: 4 */
	0x40, 0x0F, 0xC0, 0x14, 0x00, 0x02, 0x83, 0x80,
	/* #1.11, command: write_value, address: IOMUXC_SW_MUX_CTL_PAD_GPIO_EMC_00, value: 0x00, size: 4, comment: 'IOMUX config for SEMC related pins' */
	...
	/* #1.95, command: write_value, address: SEMC_MCR, value: 0x10000004, size: 4, comment: 'SEMC related configurations Begin' */
	...
	/* #2, command: check_any_bit_set, address: SEMC_INTR, value: 0x01, size: 4, comment: 'Start SDRAM refresh' */
